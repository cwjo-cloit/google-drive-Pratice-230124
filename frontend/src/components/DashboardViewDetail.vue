<template>
    ...
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="FielName" v-model="item.fielName" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Boolean label="IsIndexed" v-model="item.isIndexed" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Boolean label="IsUplaoded" v-model="item.isUplaoded" :editMode="editMode" @change="change" />
            </div>
            <div>
